...
if (isPost()) {
    ...
    if (empty($errors)) {
        ...
        $updateStatus = update('course', $dataUpdate, "id = $course_id");
        if ($updateStatus) {
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-6 pb-3">
                ...
                <img width="200" id="previewImge" class="preview-image pt-3" src="<?php echo (!empty($oldData['thumbnail'])) ? $oldData['thumbnail'] : ''; ?>" style="" alt="">
            ...
            <div class="col-3 pb-3">
                ...
                <select id="group" name="category_id" class="form-select form-control">
                    ...
                    <?php foreach ($getCourseCategory as $item): ?>
                        <option <?php echo (!empty($oldData['category_id']) && $oldData['category_id'] == $item['id']) ? 'selected' : ''; ?> value="<?php echo $item['id'] ?>"><?php echo $item['name'] ?></option>
                    <?php endforeach ?>
                </select>
            </div>
        </div>
